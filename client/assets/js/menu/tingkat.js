	...
	const act = () => {
		...
		$.ajax({
			...
			success: result => {
				...
				else tingkat({ icon: 'error', text: "gagal menambahkan data" });
	...
	const act = () => {
		...
		$.ajax({
			...
			success: result => {
				...
				else tingkat({ icon: 'error', text: "gagal mengubah data" });
		...
		$.ajax({
			...
			success: result => {
				if (result.response) {
					...
					cekKoneksi = true;
				} else tingkat({ icon: 'error', text: "gagal menghapus data" });
			}
		});
	};
	setTimeout(act, 500);
