...
var temporary = {};
const baseurl = 'http://localhost/aplikasi/tugasku/server/server.php';
	...
	const formOption = (data, index) => {
		const jenis = (data) => {
			...
			for (let i = 0; i < data.length; i++) {
				if (data[i].id == index.id_jenis) result += `<option selected="" value="${data[i].id}">${data[i].title}</option>`;
				else result += `<option value="${data[i].id}">${data[i].title}</option>`;
			}
			return result;
		}
		const bahasa = (data) => {
			let result = '';
			for (let i = 0; i < data.length; i++) {
				if (data[i].id == index.id_bahasa) result += `<option selected="" value="${data[i].id}">${data[i].title}</option>`;
				else result += `<option value="${data[i].id}">${data[i].title}</option>`;
			}
			return result;
		}
		const tingkat = (data) => {
			let result = '';
			for (let i = 0; i < data.length; i++) {
				if (data[i].id == index.id_tingkat) result += `<option selected="" value="${data[i].id}">${data[i].title}</option>`;
				else result += `<option value="${data[i].id}">${data[i].title}</option>`;
			}
			return result;
		}
